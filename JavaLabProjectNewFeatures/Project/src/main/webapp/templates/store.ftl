...
<div>
    <#if userData?has_content>
        <#if userData.role == "SELLER">
            <div>
                <a href="/offer_for_sale"><@spring.message "store.page.sales"/></a>
                <p><a href="/profile"><@spring.message "store.page.profile"/></a></p>
                <p><a href="/orders"><@spring.message "store.page.orders"/></a></p>
            </div>
        <#else>
            <div>
                <p><@spring.message "store.page.welcome"/></p>
                <p><a href="/profile"><@spring.message "store.page.profile"/></a></p>
...
<div>
    <form action="/search">
        <input type="text" name="searchText" placeholder="<@spring.message "store.page.search"/>"/>
    </form>
</div>
